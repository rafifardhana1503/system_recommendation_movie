...
- Movies Dataset
    ...
    - Mengecek info dataset menggunakan fungsi `info()`\
      Terdapat 20 kolom fitur yang terdiri dari kurang lebih 4803 baris
...
- Credits Dataset
    - Mengeksplor bagan (baris dan kolom) dari dataset menggunakan fungsi `head()`\
    - Mengecek info dataset menggunakan fungsi `info()`\
    Terdapat 4 kolom fitur dan 4803 baris

3. Data Preprocessing\
- Mengubah dan Memastikan Nama Kolom\
...
1. Melakukan Seleksi Fitur
2. Pengananan Missing Value
...
**Rubrik/Kriteria Tambahan**:
- Tahap 1: Melakukan Seleksi Fitur
    - Membuat dataset baru, dengan memilih fitur yang dibutuhkan saja yaitu fitur id, title, genres, keywords, overview, cast, crew
- Tahap 2: Penanganan Missing Value
...
- Tahap 3: Pengecekan Duplikasi Data
    - Hasil pengecekan tidak terdapatnya duplikasi data pada dataset fitur seleksi
- Tahap 4: Mengekstrak, Menggabungkan, dan Memberi Bobot List pada Isi Fitur
...
- Tahap 5: Normalisasi Teks (Cleaning Text) pada Isi Fitur
